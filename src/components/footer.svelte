    ...
    <div class="flex-wrapper">
        ...
        <div class="status-wrapper">
            ...
            <p class="large-text" bind:this={statusElem}>
                You can also contact me by phone: <br><br> +33 6 66 66 83 00 41
            </p>
            <a class="button large-text" bind:this={fullEmailLinkElem} href="lucien.rondier@student-cs.fr" target="_blank">+33 6 66 66 83 00 41</a>
        </div>
